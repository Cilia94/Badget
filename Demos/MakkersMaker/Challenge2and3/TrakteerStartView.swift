...
class TrakteerStartView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        let img = UIImage(named: "trakteren")
        let imgv = UIImageView(image: img)
        imgv.frame = CGRectMake(-80, 80, img!.size.width, img!.size.height)
        self.addSubview(imgv)
        
        
        let uitlegCh = "Neem een foto en de app bepaalt wie moet trakteren!"
        ...
        let info = UILabel(frame: CGRectMake(50, 445,
